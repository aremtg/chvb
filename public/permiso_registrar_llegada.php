    ...
    <main class="p-4 md:p-6 max-w-lg mx-auto space-y-4">
        ...
        <form id="formLlegada" class="space-y-4">
            ...
            <div class="grid grid-cols-2 gap-3">
                <div><label class="block text-sm text-gray-700 mb-1">Fecha de llegada</label><input type="date" id="fechaLlegada" required class="w-full border border-gray-300 rounded-xl px-3 py-2"></div>
                <div><label class="block text-sm text-gray-700 mb-1">Hora de llegada</label><input type="time" id="horaLlegada" required class="w-full border border-gray-300 rounded-xl px-3 py-2"></div>
            </div>
            <div>
                <label class="block text-sm text-gray-700 mb-1">Evidencia (obligatoria)</label>
                <input type="file" id="evidenciaLlegada" required class="w-full border border-gray-300 rounded-xl px-3 py-2 text-sm">
            </div>
