...
<body class="bg-gray-100 min-h-screen">
    ...
    <header class="bg-white shadow px-6 py-4 flex justify-between items-center">
        <div>
            ...
            <h1 class="text-lg font-bold text-gray-800 mt-1">Panel de Alarmas</h1>
        </div>
    </header>
                ...
                <table class="w-full text-sm text-left">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        <?php foreach ($alarmas as $al): ?>
                            <?php $vencida = strtotime($al['alarma_fecha']) < strtotime('today'); ?>
                            <tr class="<?= $vencida ? 'bg-red-50' : '' ?>">
                                ...
                                <td class="px-4 py-3">
                                    <span class="px-2 py-1 rounded text-xs <?= $vencida ? 'bg-red-100 text-red-700' : 'bg-orange-100 text-orange-700' ?>">
