   ...
   <main class="p-6 max-w-6xl mx-auto space-y-6">
    ...
    <div class="flex gap-3">
        ...
        <a href="/chvb/public/alarmas.php"
            class="bg-orange-500 hover:bg-orange-600 text-white font-medium px-4 py-2 rounded transition">
                ...
                <?php foreach ($cumpleanos as $emp): ?>
                    <li class="py-3 flex justify-between items-center">
                        ...
                        <div class="text-right">
                            ...
                            <p class="text-xs <?= $emp['dias_faltantes'] == 0 ? 'text-green-600 font-bold' : 'text-gray-400' ?>">
